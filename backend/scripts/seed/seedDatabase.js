...
const syllabusData = [
    ...
    // --- SEMESTER 7 ---
    {
        ...
        credits: 2,
        units: [
            { unitNumber: 1, unitTitle: "DEMOCRATIC VALUES", topics: [{ topicName: "Understanding Democratic values" }, { topicName: "World Democracies" }, { topicName: "John Stuart Mills On Liberty" }], hours: 6 },
            { unitNumber: 2, unitTitle: "SECULAR VALUES", topics: [{ topicName: "Understanding Secular values" }, { topicName: "Interpretation of secularism in Indian context" }, { topicName: "Disassociation of state from religion" }, { topicName: "Acceptance of all faiths" }, { topicName: "Encouraging non-discriminatory practices" }], hours: 6 },
            { unitNumber: 3, unitTitle: "SCIENTIFIC VALUES", topics: [{ topicName: "Scientific thinking and method" }, { topicName: "Inductive and Deductive thinking" }, { topicName: "Proposing and testing Hypothesis" }, { topicName: "Validating facts using evidence based approach" }, { topicName: "Skepticism and Empiricism" }, { topicName: "Rationalism and Scientific Temper" }], hours: 6 },
            { unitNumber: 4, unitTitle: "SOCIAL ETHICS", topics: [{ topicName: "Application of ethical reasoning to social problems" }, { topicName: "Gender bias and issues" }, { topicName: "Gender violence" }, { topicName: "Social discrimination" }, { topicName: "Constitutional protection and policies" }, { topicName: "Inclusive practices" }], hours: 6 },
            { unitNumber: 5, unitTitle: "SCIENTIFIC ETHICS", topics: [{ topicName: "Transparency and Fairness in scientific pursuits" }, { topicName: "Scientific inventions for the betterment of society" }, { topicName: "Unfair application of scientific inventions" }, { topicName: "Role and Responsibility of Scientist" }], hours: 6 }
        ],
