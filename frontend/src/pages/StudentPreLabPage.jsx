...
import './StudentPreLabPage.css'; // Import the new CSS
...
const StudentPreLabPage = () => {
    ...
    const startQuiz = async (lab) => {
        try {
            ...
            setResult(null);
            setTimeLeft(remaining); // Use global remaining time instead of full duration
        } catch (err) {
    ...
    if (loading) {
        return (
            <div className="loading-view">
                ...
                <p className="no-labs-text loading-small">Loading Pre-Labs...</p>
            </div>
        );
    }
    ...
    return (
        <div className="prelab-container">
            ...
            <header className="prelab-header">
                <div className="prelab-header-content">
                    <div className="prelab-icon-box">
                        <BeakerIcon className="prelab-icon" />
                    </div>
                    <div>
                        <h1 className="prelab-title">Pre-Lab <span>Assessments</span></h1>
                        <p className="prelab-subtitle">Verify your understanding before starting the practical session.</p>
                    </div>
                </div>
            </header>
            ...
            {labs.length === 0 ? (
                <div className="no-labs-card">
                    ...
                    <p className="no-labs-text">No pre-labs assigned for your semester yet.</p>
                </div>
            ) : (
                <div className="labs-grid">
                    {labs.map((lab) => (
                        ...
                        >
                            ...
                            <p className="lab-desc">{lab.description || 'Complete this pre-lab quiz to proceed with the experiment.'}</p>
                        ...
                        >
                            {!result ? (
                                ...
                                <div className="result-view">
                                    ...
                                    <p className="result-subtitle">You've successfully completed the pre-lab assessment.</p>
                    ...
                    >
                        ...
                        >
                            <div className="review-header">
                                <div>
                                    <h3 className="prelab-title-small">Your Response Analysis</h3>
                                        ...
                                        <div key={idx} className={`review-question-card ${studentAns?.isCorrect ? 'correct' : 'incorrect'}`}>
                                            ...
                                            {(q.explanation || studentAns?.isCorrect === false) && (
                                                <div className="explanation-box">
                                                    ...
                                                    <p className="explanation-text">{q.explanation || 'Review the lab documentation for detailed conceptual understanding.'}</p>
                                                </div>
                                            )}
                                        </div>
                                    );
